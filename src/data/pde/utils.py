...
def plot_mesh(mesh, scalars, dataset_name, name):
...
def screenshot_mesh(mesh, scalars, dataset_name, name, save_path):
...
def get_mesh_laplacian(
    ...
    cot_deg = scatter(cot_weight, cot_index[0], dim=0, dim_size=num_nodes, reduce="sum")
    ...
    if normalization is not None:
        ...
        area_deg = scatter(
            area_weight, area_index[0], dim=0, dim_size=num_nodes, reduce="sum"
        )
