...
class SingleMeshPDE(InMemoryDataset):
    """For fineness and roughness experiments"""
    ...
    def __init__(
        ...
        """
        :param str split: choose between 'train', 'test_time', 'test_init'
        """
    ...
    def raw_file_names(self) -> str:
        return [f"armadillo_{i}" for i in range(self.num_samples)]

    @property
    def processed_file_names(self):
        base_paths = ["train", "test_time", "test_init"]
        return [
    ...
    def process(self):
        ...
        test_time_idx = int(self.maxT * 0.8) + 1
        test_sample_idx = int(self.num_samples * 0.67)
    ...
    def len(self) -> int:
        ...
        n = self._data.sample_idx.shape[0] * (
